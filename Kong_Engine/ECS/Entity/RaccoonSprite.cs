...
namespace Kong_Engine.Objects
{
    public class RaccoonSprite : BaseEntity
    {
        ...
        private Rectangle[] walkLeftFrames;
        private Rectangle[] walkRightFrames;
        private Rectangle[] walkUpFrames;
        private Rectangle[] walkDownFrames;
        ...
        public RaccoonSprite(Texture2D spriteSheet)
        {
